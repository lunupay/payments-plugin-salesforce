...
function Handle(basket, paymentInformation, paymentMethodID, req) {
    ...
    const cardErrors = {};
    const cardNumber = paymentInformation.cardNumber.value;
    const cardSecurityCode = paymentInformation.securityCode.value;
    const expirationMonth = paymentInformation.expirationMonth.value;
    const expirationYear = paymentInformation.expirationYear.value;
    const serverErrors = [];
    let creditCardStatus;


    const cardType = paymentInformation.cardType.value;
    const paymentCard = PaymentMgr.getPaymentCard(cardType);
    ...
    if (paymentMethodID === PaymentInstrument.METHOD_CREDIT_CARD) {
        ...
        const paymentCardValue = PaymentMgr.getPaymentCard(paymentInformation.cardType.value);
